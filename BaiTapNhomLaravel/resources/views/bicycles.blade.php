...
<html>
<head>
    <title>Bike Shop - Ecommerce Category Flat Bootstrap Responsive Website Template | Bicycles :: w3layouts</title>
...
<body>
    ...
    <!-- Nội dung khác của trang sẽ được thêm ở đây -->
...
<div class="bikes">		 
	 <div class="mountain-sec">
		 ...
		 <a href="{{ route('product.details') }}"><div class="bike">				 
		     ...
		     <div class="bike-cost">
				 ...
				 <div class="fast-viw">
						<a href="{{ route('product.details') }}">Quick View</a>
				 </div>
			 </div></a>
			 <a href="single.html"><div class="bike">				 
				 ...
				 <div class="bike-cost">
					 ...
					 <div class="bike-cart">						 
						 <a class="buy" href="{{ route('product.details') }}">BUY NOW</a>
					 </div>
					 <div class="clearfix"></div>
				 </div>
				 <div class="fast-viw">
	  ...
	  <div class="singlespeed-sec">
		   <h2>SINGLE SPEED-BIKES</h2>
			 ...
			 <a href="{{ route('product.details') }}"><div class="bike none2">				 
			 ...
			 <a href="{{ route('product.details') }}"><div class="bike none1">				 
